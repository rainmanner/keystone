    ...
    [7070], {
        35666: t => {
            var r = function(t) {
                ...
                return m.prototype = w, o(E, "constructor", {
                ...
                }, _(j.prototype), h(j.prototype, c, (function() {
                    return this
                    ...
                    constructor: P,
                    reset: function(t) {
                        if (this.prev = 0, this.next = 0, this.sent = this._sent = r, this.done = !1, this.delegate = null, this.method = "next", this.arg = r, this.tryEntries.forEach(N), !t)
